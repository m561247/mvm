...
func init() {
	stdlib.Values["syscall"] = map[string]reflect.Value{
		...
		"DMDIR":               reflect.ValueOf(syscall.DMDIR),
		...
		"EPLAN9":              reflect.ValueOf(&syscall.EPLAN9),
		"ESPIPE":              reflect.ValueOf(&syscall.ESPIPE),
		"ETIMEDOUT":           reflect.ValueOf(&syscall.ETIMEDOUT),
		"ErrBadName":          reflect.ValueOf(&syscall.ErrBadName),
		"ErrBadStat":          reflect.ValueOf(&syscall.ErrBadStat),
		"ErrShortStat":        reflect.ValueOf(&syscall.ErrShortStat),
